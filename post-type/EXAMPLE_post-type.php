 ...
 *
 * Example structure for CPT; includes
 * usage for metaboxes and templating
 *
...
/**
 * Exclude from WYSIWIG "link to existing content" popup
 *
 * @param $query
 * @return mixed
 */
function team_member_wp_link_query_args($query) {
    $pt_new = [];

    $exclude_types = ['team_member'];
...
add_filter('wp_link_query_args', 'team_member_wp_link_query_args');