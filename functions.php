...
{
    wp_enqueue_style('login_custom_style',get_stylesheet_directory_uri().'/css/LoginStyle.css',['login']);
}
...
{
    //css
    wp_enqueue_style( 'theme_admin_css', get_template_directory_uri() . '/css/adminStyle.css' );
}
